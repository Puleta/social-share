<?php
/**
 * Plugin name: Librafire
 * Description: social share
 * Author: Ognjen Pultic
 * Version: 1.0.0 
 * Text domain: librafire
 */
...
function social_share_settings()
{
    ...
    add_settings_field( "social-share-size", "choose icons size","social_share_size_checkbox","social-share","social_share_config_section");
    ...
    register_setting("social_share_config_section","social-share-size");
}
 
function social_share_size_checkbox()
{
   ?>
    <input type="checkbox" name= "social-share-size" value="15px" <?php checked(1, get_option('social-share-size'), true); ?> /> Check for 15px size
   <?php
   }
...
function add_social_share_icons($content)
{
    ...
    if(get_option("social-share-size") == 1)
    {
      $html = "<div class='social-share-wrapper small-size '><div class='share-on'>Share on: </div>";
    }
